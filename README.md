...
기존 LangChain의 CharacterTextSplitters 혹은 RecursiveCharacterTextSplitter는 글자 수나 정규식으로 텍스트를 분할해서, 문장 중간에서 잘리는 경우가 많습니다. **llm-chunker**는 맥락을 이해합니다—**법률 문서의 조항 경계(추천)**, 소설의 감정 변화, 주제 전환 등을 감지합니다.
